...
HD_PWD='C:/Users/14158/Assignment5/Assignment5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_top_level.tcl
