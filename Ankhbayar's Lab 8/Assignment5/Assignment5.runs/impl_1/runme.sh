...
HD_PWD='C:/Users/14158/Assignment5/Assignment5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPGA_top_level.tcl -notrace
