...
HD_PWD='D:/Documents HDD/School/CMPE 140/CMPE140Labs/Lab1_N_FACT2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NFact_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NFact_FPGA.tcl
