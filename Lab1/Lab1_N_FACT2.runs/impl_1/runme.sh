...
HD_PWD='D:/Documents HDD/School/CMPE 140/CMPE140Labs/Lab1_N_FACT2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NFact_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NFact_FPGA.tcl -notrace
